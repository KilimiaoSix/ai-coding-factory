# AI-Coding-Factory 实施蓝图

## 1. 文档定位与阅读方式

本文件是 `AI-Coding-Factory` 的唯一主文档，用于统一以下内容：
...
- [ai-coding-factory-project-proposal.md](./ai-coding-factory-project-proposal.md)
- [ai-coding-factory-review.md](./ai-coding-factory-review.md)
- [ai-coding-factory-preliminary-design-notes.md](./ai-coding-factory-preliminary-design-notes.md)

相关方法与背景材料保留为参考输入：

- [dark-factory-development-pattern.md](./dark-factory-development-pattern.md)
- [bmad-standard-evaluation.md](./bmad-standard-evaluation.md)
...
因此，`AI-Coding-Factory` 的目标不是继续强化“单 Agent 工具”，而是构建一层面向组织交付的控制平面，让 AI 从“局部协助者”变成“受控研发团队”。
...
- 当前仓库足以作为 `AI-Coding-Factory` 的执行内核与交互壳
...
基于当前仓库继续开发 `AI-Coding-Factory` 是可行的，但前提是边界必须保持清晰：不能把执行基座误写成控制平面，不能把首期 MVP 和完整路线图混为一体，不能把需求、验证、缺陷和 Gate 只留在聊天上下文里，也不能忽略控制平面与代码版本的锚定关系。
